...
public class MemberController {
    ...
    // 필드 - 의존성 필드 ( 객체가 일을 하기위해 다른 객체에 의존)
    Scanner sc;
    MemberRepository mr;
    ...
    void mainView() {
        ...
        System.out.println("*2. 전체회원 조회하기");
        System.out.println("*3. 개별회원 조회하기");
        System.out.println("*4. 회원정보 수정하기");
        System.out.println("*5. 회원정보 삭제하기");
        System.out.println("*6. 회원정보 복구하기");
        System.out.println("*7. 회원정보 종료하기");
        System.out.println("============================");
    ...
    Gender checkCorrectGenderInput() {
        while (true) {
            ...
            switch (genderString) {
                ...
                default:
                    System.out.println("성별을 M/F로 입력해주세요");
            }
        }
    }
