...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // List<Transaction>
        List<Transaction> AscendingValue2021 = transactions.stream()
                .filter(trs -> trs.getYear()==2021)
                .sorted(Comparator.comparing(Transaction::getValue))
                .collect(Collectors.toList());
        AscendingValue2021.forEach(System.out::println);
        ...
        // 거래자리스트로 이름순으로 오름차정렬.
        // List<Trader>
        List<Trader> WorkAtCam = transactions.stream()
        ...
        WorkAtCam.forEach(System.out::println);
        ...
        // 연습 6: Cambridge에 사는 거래자의 모든 거래액의 총합 출력.
                ...
                int TotalValueinCam = transactions.stream()
                        .filter(trs->trs.getTrader().getCity().equals("Cambridge"))
                        .mapToInt(trs->trs.getValue())
                        .sum();
        System.out.println("TotalValueinCam = " + TotalValueinCam);
