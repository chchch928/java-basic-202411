...
public class Mapping {
    public static void main(String[] args) {
        ...
        List<SimpleDish> simpleDishes = menuList.stream()
                .map(menu -> new SimpleDish(menu.getName(), menu.getCalories()))
                .collect(toList());
...
//        List<Object> highCaloriesType = menuList.stream()
//                .filter(m -> m.getCalories()>500)
//                .map(m -> {
//                    Map<String, Object> menuMap = new HashMap<>();
//                    menuMap.put("menuName", m.getName());
//                    menuMap.put("type", m.getType().getDescription());
//                    return menuMap;
//                })
//                .collect(toList());
//
//        System.out.println("highCaloriesType = " + highCaloriesType);
